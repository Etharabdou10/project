    ...
    <div class="mx-2">
      ...
      @method('put')
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input type="text" placeholder="" class="form-control py-2" value="{{old('category_name',$category->category_name)}}" name="category_name"/>
            @error('category_name')
