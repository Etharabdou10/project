                ...
                <ul class="navbar-nav">
                  <li class="nav-item dropdown dropdown-center user-dropdown">
                    <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="true">
                      <img class="img-xs rounded-circle" src="{{asset('admin/images/avatar-default.svg')}}" alt="Profile image" />
                    </a>
                ...
                <table class="table table-hover display" id="_table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center"><a class="text-decoration-none text-dark" href="edit_category.html"><img src="{{asset('admin/images/edit-svgrepo-com.svg')}}"></a></td>
                            <td class="text-center"><a class="text-decoration-none text-dark" href="#"><img src="{{asset('admin/images/trash-can-svgrepo-com.svg')}}"></a></td>
                        </tr>
                        <tr>
